...
<body>
	...
	<table>
		...
		<tbody>
			<form action="./bookmark-update-fin.jsp" method="GET">
				<tr>
					<th>북마크 이름</th>
					<td><input type="text" id="bookNameUpdate" name="bookNameUpdate"
						value="<%=bookName%>"></td>
				</tr>
				<tr>
					<th>순서</th>
					<td><input type="text" id="orderUpdate" name="orderUpdate"
						value="<%=order%>"></td>
				</tr>
				<input type="hidden" id="bookIdUpdate" name="bookIdUpdate" value="<%=bookId %>">
				<tr>
					<td colspan="17" align="center"><button type="submit" onclick = "updateAlert()">수정</button></td>
				</tr>
			</form>
		</tbody>
	</table>
